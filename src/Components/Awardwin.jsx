...
import { awardwinData } from "../Utils/database";
import Slider from "react-slick";
import Awardwincards from "./Awardwincards";
  ...
  return (
    <div className="recentWrapper">
      <div className="recentMain">
        <h2 className="recHEad1">Award-Winning Bingeworthy TV Shows</h2>
        <div className="recentArea">
          <div className="recentMovies">
            <Slider className="local" {...settings}>
              {awardwinData.map((value) => {
                return (
                  <Awardwincards
