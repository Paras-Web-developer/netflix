...
export declare function useQueryReducer<R extends Reducer<any, any>>(itemName: string, reducer: R, initialState: ReducerState<R>, queryStateOpts?: QueryStateOpts): [ReducerState<R>, import("use-location-state").QueryDispatch<import("use-location-state").ReducerAction<R>>];
